...
ShadingModel::ShadingModel(Vector start, Vector end)
{
	this->start = start;
	this->end = end;
}

ShadingModel::ShadingModel(Vector start, Vector end, Vector startV, Vector endV)
{
	this->start = start;
	this->end = end;
	this->startV = startV;
...
void ShadingModel::ConstantDraw(Vector color, std::vector<std::vector<float>>& Z_depth, std::vector<std::vector<Vector>>& Z_frame)
{
...
void ShadingModel::GouraudDraw(std::vector<std::vector<float>>& Z_depth, std::vector<std::vector<Vector>>& Z_frame)
{
...
void ShadingModel::PhongDraw(Vector objectColor, Vector camera, Vector ka, Vector kd, Vector ks, int focus, std::vector<std::vector<float>>& Z_depth, std::vector<std::vector<Vector>>& Z_frame)
{
	Vector v1 = this->start;
	Vector v2 = this->end;
